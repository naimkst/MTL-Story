    ...
    return (
        <header id="header" className={props.topbarNone}>
            <div className="header-topbar">
                <ul>
                    <li>ACCESS OUR MTLSTORIES WEEKLY <a href='#'>NEWSLETTER HERE!</a></li>
                    <li>
                            ...
                            <div className="col-lg-10 col-md-1 col-1">
                                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li>
                                            <Link activeClass="active" to="calender" spy={true} smooth={true} duration={500} offset={-95}>CALENDAR</Link>
                                        </li>
                                        <li><Link activeClass="active" to="service" spy={true} smooth={true} duration={500} offset={-95}>SERVICES</Link></li>
                                        <li>
                                            <Link activeClass="active" to="merch" spy={true} smooth={true} duration={500} offset={-95}>MERCH</Link>
                                        </li>
                                        <li>
                                            <Link activeClass="active" to="contact" spy={true} smooth={true} duration={500} offset={-95}>CONTACT US</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
